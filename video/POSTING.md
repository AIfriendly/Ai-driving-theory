...
Site link goes in the bio, not the caption — TikTok captions do not make links
clickable.
...
*(EN, if posting the English cut: The rule changes after dark — At night on a two-way road, what is the maximum speed?)*
...
*(EN, if posting the English cut: Who gets the ticket? — During a driving lesson the learner commits a traffic violation. Who is held responsible?)*
...
*(EN, if posting the English cut: You need to know this number — Which number do you call for an ambulance in the Kurdistan Region?)*
...
**Title / caption (Kurdish)**
```
زۆربەی خەڵک ئەمە بە هەڵە دەزانن 🤔
...
*(EN, if posting the English cut: Most people get this one wrong — You are towing another car with a rope. What is the maximum speed?)*
...
*(EN, if posting the English cut: A lot of people do this wrong — How should a pregnant woman wear the seat belt?)*
...
*(EN, if posting the English cut: A green arrow is not a green light — A traffic light shows a green ARROW rather than a round green lamp. Who may go?)*
...
*(EN, if posting the English cut: Who actually has right of way? — According to the traffic law order of priority, right of way belongs to:)*
...
*(EN, if posting the English cut: Most people guess too close — At 30 km/h, how far should you stay behind the vehicle in front?)*
...
*(EN, if posting the English cut: What is that yellow line telling you? — There is a solid yellow line painted along the kerb where you want to park. Is parking allowed?)*

---

## 10. `unlicensed-ku.mp4`
